...
@synthesize delegate;
@synthesize labelText,thumbImage;
...
- (void)loadView {
	...
	trackImage = [UIImage imageNamed:@"slide.png"];
	...
	UIView *view1 = [[UIView alloc] initWithFrame:sliderBackground.frame];
	view1.frame = CGRectMake(30, 60, 60, 70);
	//view1.frame = CGRectMake(30, 60, 80, 70);

	[view1 addSubview:sliderBackground];
	...
	sliderFrame.size.width -= 10; //each "edge" of the track is 23 pixels wide
	slider.frame = sliderFrame;
	slider.center = sliderBackground.center;
	slider.backgroundColor = [UIColor clearColor];
	thumbImage = [UIImage imageNamed:@"sliderThumb.png"];
	[slider setThumbImage:thumbImage forState:UIControlStateNormal];
	slider.minimumValue = 0.0;
	slider.maximumValue = 1.0;
	slider.continuous = YES;
	slider.value = 0.0;
	//== invisible track in slider
