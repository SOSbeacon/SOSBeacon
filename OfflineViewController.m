...
- (void)viewDidLoad {
	...
	[actionSheet1 addButtonWithTitle:@"Family"];
	[actionSheet1 addButtonWithTitle:@"Friends"];
	[actionSheet1 addButtonWithTitle:@"Family & Friends"];
	[actionSheet1 addButtonWithTitle:@"Neighborhood watch"];
	...
	[tableArr addObject:@"Send Group Check-in"];
	[tableArr addObject:@"Send Group Emergency Alert"];
...
-(void)sendSMS
{
	...
	NSString *strImei = [NSString stringWithString:[device uniqueIdentifier]];
	...
	message = [NSString stringWithFormat:@"%@|%@|%@|%@|%@",message,selectGroup,appDelegate.latitudeString,appDelegate.longitudeString,textViewMessage.text];
    ...
    */
	...
	labelType.text = @"Send Group Check-in";
