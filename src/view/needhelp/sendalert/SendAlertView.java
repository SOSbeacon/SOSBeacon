package view.needhelp.sendalert;
...
import controller.needhelp.sendalert.SendAlertController;

public class SendAlertView extends AView implements ISendAlertView {
	...
	ISendAlertController controller;
...
//	}
	...
	void back(){
		vRecord.stop();
		aRecord.stop();
		//controller.sendAlert(aRecord.getVoiceNote(),
...
//			vRecord.start();
	...
	public SendAlertView(int timeRecord) {
		super();
		this.timeRecord=timeRecord;
		controller = new SendAlertController(this, new CheckinModel());
