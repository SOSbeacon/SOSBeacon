package cnc.sosbeacon.constants;
...
public interface Constants {
	...
	public final static String APP_DIR = "SOSbeacon";
	...
	public final static String DATABASE = "sosbeacon";
	public static final String PROVIDER_NAME = "cnc.sosbeacon.provider";
	public final static String DATABASE_CREATE = "create table " + DATABASE + " (_id integer primary key autoincrement, message text, count integer);";
